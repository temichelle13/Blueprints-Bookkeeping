...
export const HealthCheckResponse = zod.object({
  ...
  db: zod.enum(["ok", "error", "missing"]),
  mongodb: zod.enum(["configured", "missing"]),
  timestamp: zod.date(),
});
...
export const UnsubscribeNewsletterByTokenQueryParams = zod.object({
  token: zod.uuid().describe("The unique unsubscribe token for the subscriber"),
});
...
export const ListContractsResponseItem = zod.object({
  ...
  remindersSent: zod.int(),
  lastReminderAt: zod.date().nullish(),
  contactInquiryId: zod.int().nullish(),
  createdAt: zod.date(),
  updatedAt: zod.date(),
});
...
export const BookingWebhookBody = zod.object({
  ...
  payload: zod.looseObject({}).optional(),
  clientName: zod.string().optional(),
  clientEmail: zod.string().optional(),
  serviceType: zod.string().optional(),
});

export const BookingWebhookResponse = zod.object({
  success: zod.boolean().optional(),
  message: zod.string().optional(),
  contracts: zod.array(zod.looseObject({})).optional(),
});
...
export const GetContractDocumentResponse = zod.unknown();
...
export const GetNexusSummaryResponseItem = zod.object({
  ...
  clientCount: zod.int(),
  foreignQualificationThreshold: zod.int(),
...
export const UpdateNexusRuleBody = zod.object({
  foreignQualificationThreshold: zod.int().optional(),
  warningThresholdPercent: zod.int().optional(),
