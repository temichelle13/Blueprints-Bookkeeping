...
export const submitContactForm = async (contactFormInput: ContactFormInput, options?: RequestInit): Promise<ContactFormResponse> => {
...
export const subscribeNewsletter = async (newsletterSubscribeInput: NewsletterSubscribeInput, options?: RequestInit): Promise<NewsletterSubscribeResponse> => {
 ...
 */
export const getUnsubscribeNewsletterByTokenUrl = (params: UnsubscribeNewsletterByTokenParams,) => {
...
export const unsubscribeNewsletterByToken = async (params: UnsubscribeNewsletterByTokenParams, options?: RequestInit): Promise<NewsletterUnsubscribeResponse> => {

  return customFetch<NewsletterUnsubscribeResponse>(getUnsubscribeNewsletterByTokenUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getUnsubscribeNewsletterByTokenQueryKey = (params?: UnsubscribeNewsletterByTokenParams,) => {
    return [
...
export const getUnsubscribeNewsletterByTokenQueryOptions = <TData = Awaited<ReturnType<typeof unsubscribeNewsletterByToken>>, TError = ErrorType<ErrorResponse>>(params: UnsubscribeNewsletterByTokenParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof unsubscribeNewsletterByToken>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getUnsubscribeNewsletterByTokenQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof unsubscribeNewsletterByToken>>> = ({ signal }) => unsubscribeNewsletterByToken(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof unsubscribeNewsletterByToken>>, TError, TData> & { queryKey: QueryKey }
}

export type UnsubscribeNewsletterByTokenQueryResult = NonNullable<Awaited<ReturnType<typeof unsubscribeNewsletterByToken>>>
...
export function useUnsubscribeNewsletterByToken<TData = Awaited<ReturnType<typeof unsubscribeNewsletterByToken>>, TError = ErrorType<ErrorResponse>>(
 params: UnsubscribeNewsletterByTokenParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof unsubscribeNewsletterByToken>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getUnsubscribeNewsletterByTokenQueryOptions(params,options)
...
export const unsubscribeNewsletter = async (newsletterUnsubscribeInput: NewsletterUnsubscribeInput, options?: RequestInit): Promise<NewsletterUnsubscribeResponse> => {
...
export const sendContract = async (sendContractInput: SendContractInput, options?: RequestInit): Promise<SendContractResponse> => {
...
export const getSendContractMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendContract>>, TError,{data: BodyType<SendContractInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendContract>>, TError,{data: BodyType<SendContractInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendContract>>, {data: BodyType<SendContractInput>}> = (props) => {
          const {data} = props ?? {};
 ...
 * @summary Manually send a contract
 */
export const useSendContract = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendContract>>, TError,{data: BodyType<SendContractInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const syncContract = async (id: number, options?: RequestInit): Promise<Contract> => {
...
export const getSyncContractMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof syncContract>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof syncContract>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof syncContract>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SyncContractMutationResult = NonNullable<Awaited<ReturnType<typeof syncContract>>>
 ...
 * @summary Sync contract status with Adobe Sign
 */
export const useSyncContract = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof syncContract>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const syncAllContracts = async ( options?: RequestInit): Promise<SyncResult> => {
...
export const getSyncAllContractsMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof syncAllContracts>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof syncAllContracts>>, TError,void, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof syncAllContracts>>, void> = () => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SyncAllContractsMutationResult = NonNullable<Awaited<ReturnType<typeof syncAllContracts>>>
 ...
 * @summary Sync all pending contracts
 */
export const useSyncAllContracts = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof syncAllContracts>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const processContractReminders = async ( options?: RequestInit): Promise<ReminderResult> => {
...
export const getProcessContractRemindersMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof processContractReminders>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof processContractReminders>>, TError,void, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof processContractReminders>>, void> = () => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ProcessContractRemindersMutationResult = NonNullable<Awaited<ReturnType<typeof processContractReminders>>>
 ...
 * @summary Process contract reminders
 */
export const useProcessContractReminders = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof processContractReminders>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getUpdateContractTemplateMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateContractTemplate>>, TError,{id: number;data: BodyType<ContractTemplateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateContractTemplate>>, TError,{id: number;data: BodyType<ContractTemplateInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateContractTemplate>>, {id: number;data: BodyType<ContractTemplateInput>}> = (props) => {
          const {id,data} = props ?? {};
...
export const bookingWebhook = async (bookingWebhookBody: BookingWebhookBody, options?: RequestInit): Promise<BookingWebhook201> => {
...
export const getBookingWebhookMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof bookingWebhook>>, TError,{data: BodyType<BookingWebhookBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof bookingWebhook>>, TError,{data: BodyType<BookingWebhookBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof bookingWebhook>>, {data: BodyType<BookingWebhookBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type BookingWebhookMutationResult = NonNullable<Awaited<ReturnType<typeof bookingWebhook>>>
 ...
 * @summary Webhook for service bookings (Calendly or manual)
 */
export const useBookingWebhook = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof bookingWebhook>>, TError,{data: BodyType<BookingWebhookBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getContractDocument = async (id: number, options?: RequestInit): Promise<Blob> => {
...
export const getGetContractDocumentQueryKey = (id: number,) => {
    return [
    `/api/contracts/${id}/document`
    ] as const;
    }


export const getGetContractDocumentQueryOptions = <TData = Awaited<ReturnType<typeof getContractDocument>>, TError = ErrorType<void>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getContractDocument>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetContractDocument<TData = Awaited<ReturnType<typeof getContractDocument>>, TError = ErrorType<void>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getContractDocument>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getAdobeSignStatus = async ( options?: RequestInit): Promise<AdobeSignStatus> => {
...
export const getGetAdobeSignStatusQueryKey = () => {
    return [
    `/api/contracts/adobe/status`
    ] as const;
    }


export const getGetAdobeSignStatusQueryOptions = <TData = Awaited<ReturnType<typeof getAdobeSignStatus>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAdobeSignStatus>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAdobeSignStatusQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAdobeSignStatus>>> = ({ signal }) => getAdobeSignStatus({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAdobeSignStatus>>, TError, TData> & { queryKey: QueryKey }
}

export type GetAdobeSignStatusQueryResult = NonNullable<Awaited<ReturnType<typeof getAdobeSignStatus>>>
...
export function useGetAdobeSignStatus<TData = Awaited<ReturnType<typeof getAdobeSignStatus>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAdobeSignStatus>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const calWebhook = async (calWebhookPayload: CalWebhookPayload, options?: RequestInit): Promise<CalWebhookResponse> => {
...
export const getCalWebhookMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof calWebhook>>, TError,{data: BodyType<CalWebhookPayload>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof calWebhook>>, TError,{data: BodyType<CalWebhookPayload>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof calWebhook>>, {data: BodyType<CalWebhookPayload>}> = (props) => {
          const {data} = props ?? {};
...
export const getNexusSummary = async ( options?: RequestInit): Promise<NexusSummaryItem[]> => {
...
export const getGetNexusSummaryQueryKey = () => {
    return [
    `/api/admin/nexus/summary`
    ] as const;
    }


export const getGetNexusSummaryQueryOptions = <TData = Awaited<ReturnType<typeof getNexusSummary>>, TError = ErrorType<void>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNexusSummary>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetNexusSummary<TData = Awaited<ReturnType<typeof getNexusSummary>>, TError = ErrorType<void>>(
...
export const getNexusRules = async ( options?: RequestInit): Promise<StateNexusRule[]> => {
...
export const getGetNexusRulesQueryKey = () => {
    return [
    `/api/admin/nexus/rules`
    ] as const;
    }


export const getGetNexusRulesQueryOptions = <TData = Awaited<ReturnType<typeof getNexusRules>>, TError = ErrorType<void>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNexusRules>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetNexusRulesQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getNexusRules>>> = ({ signal }) => getNexusRules({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getNexusRules>>, TError, TData> & { queryKey: QueryKey }
}

export type GetNexusRulesQueryResult = NonNullable<Awaited<ReturnType<typeof getNexusRules>>>
...
export function useGetNexusRules<TData = Awaited<ReturnType<typeof getNexusRules>>, TError = ErrorType<void>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNexusRules>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const updateNexusRule = async (stateCode: string,
    updateNexusRuleInput: UpdateNexusRuleInput, options?: RequestInit): Promise<StateNexusRule> => {
...
export const getUpdateNexusRuleMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateNexusRule>>, TError,{stateCode: string;data: BodyType<UpdateNexusRuleInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateNexusRule>>, TError,{stateCode: string;data: BodyType<UpdateNexusRuleInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateNexusRule>>, {stateCode: string;data: BodyType<UpdateNexusRuleInput>}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateNexusRuleMutationResult = NonNullable<Awaited<ReturnType<typeof updateNexusRule>>>
 ...
 * @summary Update nexus rule thresholds for a state
 */
export const useUpdateNexusRule = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateNexusRule>>, TError,{stateCode: string;data: BodyType<UpdateNexusRuleInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const runNexusCheck = async ( options?: RequestInit): Promise<NexusCheckResult> => {
...
export const getRunNexusCheckMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof runNexusCheck>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof runNexusCheck>>, TError,void, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof runNexusCheck>>, void> = () => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RunNexusCheckMutationResult = NonNullable<Awaited<ReturnType<typeof runNexusCheck>>>
 ...
 * @summary Trigger a manual nexus threshold check and send pending notifications
 */
export const useRunNexusCheck = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof runNexusCheck>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getNexusNotifications = async ( options?: RequestInit): Promise<NexusNotificationLog[]> => {
...
export const getGetNexusNotificationsQueryKey = () => {
    return [
    `/api/admin/nexus/notifications`
    ] as const;
    }


export const getGetNexusNotificationsQueryOptions = <TData = Awaited<ReturnType<typeof getNexusNotifications>>, TError = ErrorType<void>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNexusNotifications>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetNexusNotificationsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getNexusNotifications>>> = ({ signal }) => getNexusNotifications({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getNexusNotifications>>, TError, TData> & { queryKey: QueryKey }
}

export type GetNexusNotificationsQueryResult = NonNullable<Awaited<ReturnType<typeof getNexusNotifications>>>
...
export function useGetNexusNotifications<TData = Awaited<ReturnType<typeof getNexusNotifications>>, TError = ErrorType<void>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNexusNotifications>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
