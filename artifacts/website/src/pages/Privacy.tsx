      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="glass-card rounded-2xl p-8 space-y-6 text-[15px] leading-relaxed text-muted-foreground">
          <section>
            ...
            <p>
              Blueprints & Bookkeeping LLC ("we," "our," or "us") is a financial
              consulting firm based in Roseburg, Oregon. We provide bookkeeping,
              business planning, and related services to clients nationwide.
          ...
          <section>
            ...
            <p className="mt-3">
              We do not collect payment information directly — payment
              processing is handled by secure third-party providers (Stripe).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              emails containing financial tips, business insights, and updates
              about our services. You may unsubscribe at any time by clicking
              the unsubscribe link in any email or visiting our{" "}
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              have specific rights regarding their personal data. As an
              Oregon-based business, we respect and uphold these rights. You
              have the right to:
            </p>
            <ul className="list-disc list-inside space-y-2 pl-2">
              ...
              <li>
                <span className="text-white font-medium">Right to Correct</span>{" "}
                — Request correction of inaccurate personal data we hold about
                you.
              </li>
              <li>
                <span className="text-white font-medium">Right to Delete</span>{" "}
                — Request deletion of personal data you have provided to us or
                that we have obtained about you.
              </li>
              <li>
                <span className="text-white font-medium">
                  Right to Data Portability
                </span>{" "}
                — Obtain a copy of your personal data in a portable and readily
                usable format, to the extent technically feasible.
              </li>
              <li>
                <span className="text-white font-medium">Right to Opt Out</span>{" "}
                — Opt out of the processing of your personal data for purposes
                of sale, targeted advertising, or certain types of profiling.
              </li>
              <li>
                <span className="text-white font-medium">Right to Appeal</span>{" "}
                — Appeal a decision we make regarding your privacy rights
                request.
              </li>
            </ul>
            <p className="mt-4">
              ...
              . We will respond to your request within 45 days. If we need
              additional time, we will notify you and may extend the response
              period by an additional 45 days.
            </p>
            <p className="mt-3">
              If we deny your request, you may appeal the decision by contacting
              us at the same email address. We will respond to your appeal
              within 45 days.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              signal. GPC is a browser-level setting that lets you tell websites
              you do not want your personal data sold or shared. When we detect
              the GPC signal from your browser, we treat it as a valid opt-out
              request and will not engage in any discretionary tracking or data
              sharing for your visit.
            </p>
            <p className="mb-3">
              To enable GPC, you can use a supported browser or browser
              extension that sends the{" "}
              <code className="bg-white/10 px-1.5 py-0.5 rounded text-sm">
                Sec-GPC
              </code>{" "}
              header automatically. Supported options include:
            </p>
            <ul className="list-disc list-inside space-y-1 pl-2">
            ...
            <p className="mt-3">
              ...
              automatically detects and honors the signal on every request.
            </p>
          </section>
