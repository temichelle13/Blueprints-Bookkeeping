      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-5 text-foreground leading-relaxed mb-12">
            <p>
              Tea brings a rare intersection of enterprise financial management,
              software engineering, and cybersecurity to Blueprints &amp;
              Bookkeeping, LLC.
            </p>
            <p>
              With deep experience in financial operations for complex,
              multi-entity businesses, Tea understands exactly where standard
              accounting breaks down. Generalist bookkeepers hit a "complexity
              ceiling," leaving founders with messy historical data, mismatched
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
            <div className="glass-card rounded-xl p-6 group hover:border-accent/20 transition-all">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Comfortably managing crypto-assets, multi-location structures,
                and complex financial forecasts.
              </p>
            </div>
            <div className="glass-card rounded-xl p-6 group hover:border-accent/20 transition-all">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                As a CEH v12, your sensitive data is protected by
                enterprise-grade security. No offshore labor, ever.
              </p>
            </div>
          </div>
          ...
          <div className="glass-card rounded-2xl p-8 mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Our books are managed by a professional trained in IBM-standard
              cybersecurity and data classification. Your sensitive financial
              data is protected with the same rigor used in enterprise
              environments.
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
              {aboutSecurityBadges.map((badge) => (
                ...
                >
                  <div
                    className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${badge.color} border ${badge.border} flex items-center justify-center mb-3 group-hover:scale-105 transition-transform`}
                  >
                    <img
                      src={badge.badge}
                      alt={badge.name}
                  ...
                  <span className="text-xs text-muted-foreground font-medium group-hover:text-accent transition-colors">
                    {badge.name}
                  </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="glass-card rounded-2xl p-6">
              <h3 className="font-bold text-sm uppercase tracking-wider text-muted-foreground mb-5 flex items-center gap-2">
                <BadgeCheck className="w-4 h-4 text-accent" /> Professional
                Certifications
              </h3>
              <ul className="space-y-3 text-sm text-foreground">
                <li className="flex items-center gap-3">
                  <Award size={15} className="text-accent shrink-0" /> Certified
                  Ethical Hacker (CEH v12)
                </li>
                <li className="flex items-center gap-3">
                  <Award size={15} className="text-accent shrink-0" />{" "}
                  QuickBooks ProAdvisor Advanced
                </li>
                <li className="flex items-center gap-3">
                  <Award size={15} className="text-accent shrink-0" /> Advanced
                  Crypto Accounting Certified
                </li>
              </ul>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <ul className="space-y-3 text-sm text-foreground">
                <li className="flex items-center gap-3">
                  <Award size={15} className="text-accent shrink-0" /> MBA
                  Coursework, Walden University
                </li>
                <li className="flex items-center gap-3">
                  <Award size={15} className="text-accent shrink-0" /> Business
                  Administration Studies, St. Andrews University
                </li>
              </ul>
              <p className="text-xs text-muted-foreground mt-4 italic">
                Plus extensive professional development and continuing education
                across finance, cybersecurity, and technology.
              </p>
            </div>
          </div>
          ...
          <div className="glass-card rounded-2xl p-8 mb-12">
            <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  These badges link directly to the public issuer verification
                  pages for the credentials earned.
                </p>
              </div>
              <Link
                href="/about/credentials"
