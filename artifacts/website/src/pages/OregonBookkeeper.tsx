  ...
  const jsonLd = [
    {
      ...localBusinessSchema(),
      description:
        "Professional bookkeeper in Roseburg, Oregon serving Southern Oregon businesses. Advanced bookkeeping, historical cleanup, multi-entity structuring, and professional business plans.",
      areaServed: [
        {
          "@type": "City",
          name: "Roseburg",
    ...
    serviceSchema({
      ...
      description:
        "Advanced bookkeeping and financial services for Southern Oregon businesses. Serving Roseburg, Douglas County, and the greater Southern Oregon region.",
    ...
    <div className="pt-24 pb-20">
      ...
      <section className="py-16 mb-10 relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Blueprints & Bookkeeping provides advanced bookkeeping and business
            planning services from Roseburg, Oregon — serving Douglas County,
            Southern Oregon, and businesses nationwide.
          </p>
        </div>
      </section>
        ...
        <div className="glass-card rounded-2xl p-8 border border-accent/10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-white">
              Proudly Based in Roseburg, Oregon
            </h2>
          </div>
          <p className="text-muted-foreground text-[15px] leading-relaxed mb-6">
            We're a locally owned bookkeeping firm rooted in Roseburg, serving
            the unique needs of Southern Oregon businesses. From Douglas County
            timber operations and agricultural enterprises to downtown Roseburg
            retailers and growing startups, we understand the local economy and
            the specific financial challenges businesses face here.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              {
                label: "Service Area",
                value: "Roseburg, Douglas County, Southern Oregon & Nationwide",
              },
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <h2 className="text-2xl font-display font-bold text-white mb-6">
          Services for Southern Oregon Businesses
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link
            href="/services/bookkeeping"
            className="glass-card-hover rounded-2xl p-6 group block"
          >
            ...
            <p className="text-muted-foreground text-[14px] leading-relaxed mb-4">
              Multi-entity structuring, historical cleanup, rule-based QBO
              automation, and rigorous monthly close procedures.
            </p>
          ...
          >
            ...
            <p className="text-muted-foreground text-[14px] leading-relaxed mb-4">
              Comprehensive, professionally written business plans with rigorous
              financial forecasting and deep market analysis.
            </p>
            <span className="text-accent text-sm font-medium flex items-center gap-1 group-hover:gap-2 transition-all">
              Learn more <ArrowRight size={14} />
            </span>
        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Schedule a free discovery call with your Roseburg, Oregon
              bookkeeping partner. We'll assess your needs and build a custom
              plan.
            </p>
