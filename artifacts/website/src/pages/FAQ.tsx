...
function FAQItem({
  ...
  return (
    <div id={id} className="border-b border-white/[0.06] last:border-0">
      <button
        id={buttonId}
      ...
      >
        <span
          className={cn(
            ...
            open ? "text-white" : "text-foreground group-hover:text-white",
          )}
        >
          {q}
        </span>
        <ChevronDown
          className={cn(
            "w-4 h-4 text-accent shrink-0 mt-0.5 transition-transform duration-300",
            open && "rotate-180",
          )}
          aria-hidden="true"
        />
  ...
  return (
    <div className="pt-24 pb-20">
      ...
      <section className="py-16 mb-10 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Straight answers about our services, process, and how we work. Don't
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 space-y-4">
        <BookkeepingDisclaimer compact title="Quick compliance note" />
        <div className="glass-card rounded-2xl p-8 text-center">
          <h3 className="text-xl font-bold text-white mb-3">
            Still have questions?
          </h3>
          <p className="text-muted-foreground text-sm mb-6">
            Book a free 30-minute discovery call or send us a message — we'll
