...
export default function Services() {
  ...
  const jsonLd = [
    serviceSchema({
      ...
      description:
        "Multi-entity structuring, historical cleanups, and rule-based QBO automation for complex businesses.",
      url: `${BASE_URL}/services`,
    }),
    serviceSchema({
      name: "Business Plans & Financial Forecasting",
      description:
        "Comprehensive, professionally written business plans with rigorous 3-to-5-year financial modeling.",
      url: `${BASE_URL}/services`,
    }),
  ];
      ...
      <section className="py-16 mb-8 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Beyond simple data entry&mdash;robust, modern financial
            infrastructure tailored for ambitious founders.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          {coreServices.map((svc) => (
            <div
              key={svc.id}
              className="glass-card-hover rounded-2xl overflow-hidden flex flex-col h-full group"
            >
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            <div className="flex-grow">
              ...
              <p className="text-muted-foreground text-[15px]">
                Tax preparation isn't part of our service offering — but we've
                built a vetted network of licensed CPAs and Enrolled Agents who
                specialize in it. We hand off clean, organized books so your tax
                season is seamless.
              </p>
            </div>
            <Link
