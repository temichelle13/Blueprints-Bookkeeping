...
export default function Bookkeeping() {
  const jsonLd = [
    serviceSchema({
      ...
      description: "Multi-entity structuring, historical cleanups, rule-based QBO automation, and rigorous monthly close procedures for complex businesses.",
  ...
  return (
    <div className="pt-24 pb-20">
      ...
      <section className="py-16 mb-10 relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[11px] font-mono font-medium tracking-widest text-muted-foreground">ONGOING SERVICE</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-6">Advanced Bookkeeping & Cleanup</h1>
          <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed">
            For complex operations that have outgrown generalist data entry. We handle multi-entity structures, historical remediation, and automated workflows that keep your financials audit-ready year-round.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <h2 className="text-2xl font-display font-bold text-white mb-6">Who This Is For</h2>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative p-8 text-center">
            <h2 className="text-2xl font-display font-bold text-white mb-4">Ready to Upgrade Your Financial Infrastructure?</h2>
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Schedule a free discovery call and we'll assess your current setup, identify gaps, and build a custom plan.
            </p>
