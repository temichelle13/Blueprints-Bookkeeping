...
import { BookOpen, CheckCircle2, ArrowRight, TrendingUp, Target, FileBarChart, BarChart3, PieChart, Briefcase } from "lucide-react";
  ...
  return (
    <div className="pt-24 pb-20">
      ...
      <section className="py-16 mb-10 relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[11px] font-mono font-medium tracking-widest text-muted-foreground">PROJECT-BASED SERVICE</span>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <h2 className="text-2xl font-display font-bold text-white mb-6">Two Tiers, One Standard of Excellence</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="glass-card-hover rounded-2xl p-8 flex flex-col">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[11px] font-mono font-medium tracking-widest text-muted-foreground">STARTUP ROADMAP</span>
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Startup Roadmap</h3>
            <p className="text-muted-foreground text-[15px] mb-5">Ideal for early-stage businesses seeking internal clarity or initial bank conversations.</p>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <h2 className="text-2xl font-display font-bold text-white mb-6">Our Process</h2>
        <div className="glass-card rounded-2xl p-8">
          <div className="space-y-6">
            {[
              ...
              { step: "5", title: "Final Delivery", desc: "You receive a polished, print-ready document and supporting financial spreadsheets within 2-4 weeks." }
            ].map((item, i) => (
